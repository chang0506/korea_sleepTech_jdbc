...
public class Main {
    public static void main(String[] args) {
        ...
        String user = "root";
        String password = "ckdgus@7719"; //? 본인의 비밀번호로 변경
...
//            stmt = conn.createStatement(); // stmt 사용
//            rs = stmt.executeQuery(sql); // SELET 실행
//
//            while (rs.next()) {
//                int id = rs.getInt("id");
...
//
//            pstmt.setString(1, "조민지");
//            pstmt.setString(2, "dfg000"); // command + d
//
